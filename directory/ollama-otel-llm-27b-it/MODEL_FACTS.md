...
status: active
license: apache-2.0
homepage: https://huggingface.co/farbodtavakkoli/OTel-LLM-27B-IT
weights: https://huggingface.co/farbodtavakkoli/OTel-LLM-27B-IT
architecture:
  type: undisclosed
...
capabilities:
  ...
  tool_use: none
  notes: Draft from HF Hub (1,356,059 downloads). Review before marking curated.
safety:
...
*Draft from HF Hub (1,356,059 downloads). Review before marking curated.*
