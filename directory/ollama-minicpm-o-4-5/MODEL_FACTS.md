...
status: active
license: apache-2.0
homepage: https://huggingface.co/openbmb/MiniCPM-o-4_5
weights: https://huggingface.co/openbmb/MiniCPM-o-4_5
architecture:
  type: undisclosed
...
capabilities:
  ...
  audio_input: enabled
  tool_use: none
  notes: Draft from HF Hub (694,166 downloads). Review before marking curated.
safety:
...
*Draft from HF Hub (694,166 downloads). Review before marking curated.*
