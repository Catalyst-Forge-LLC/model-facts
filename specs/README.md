...
Normative and roadmap documents for ModelFacts. Prefer linking here over root-level
copies; root stubs exist only for old URLs.

| Doc | Role |
|---|---|
| [`SPEC.md`](./SPEC.md) | Per-file `MODEL_FACTS.md` format (normative) |
