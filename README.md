...
See the [full worked example](./examples/MODEL_FACTS.md), the [hand-authored template](./examples/MODEL_FACTS.template.md), and the [specification](./SPEC.md) for the complete field list. The five fact groups:
...
[`directory-tools/`](./directory-tools/). See [`DIRECTORY_SPEC.md`](./DIRECTORY_SPEC.md).
