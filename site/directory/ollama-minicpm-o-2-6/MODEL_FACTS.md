...
status: active
license: apache-2.0
homepage: https://huggingface.co/openbmb/MiniCPM-o-2_6
weights: https://huggingface.co/openbmb/MiniCPM-o-2_6
architecture:
  type: undisclosed
...
capabilities:
  ...
  audio_input: enabled
  tool_use: none
  notes: Draft from HF Hub (275,363 downloads). Review before marking curated.
safety:
...
*Draft from HF Hub (275,363 downloads). Review before marking curated.*
