...
name: OTel-LLM-E4B-IT
developer: farbodtavakkoli
status: active
license: apache-2.0
homepage: https://huggingface.co/farbodtavakkoli/OTel-LLM-E4B-IT
weights: https://huggingface.co/farbodtavakkoli/OTel-LLM-E4B-IT
architecture:
  type: undisclosed
...
capabilities:
  ...
  tool_use: none
  notes: Draft from HF Hub (1,566,806 downloads). Review before marking curated.
safety:
...
*Draft from HF Hub (1,566,806 downloads). Review before marking curated.*
