...
status: active
license: UNKNOWN
homepage: https://ollama.com/library/medgemma
weights: https://ollama.com/library/medgemma
architecture:
  type: undisclosed
  parameters: 27B
...
capabilities:
  ...
  tool_use: none
  notes: Draft. MedGemma is a collection of Gemma 3 variants that are trained for performance on medical text and image comprehension.
safety:
...
*Draft. MedGemma is a collection of Gemma 3 variants that are trained for performance on medical text and image comprehension.*
